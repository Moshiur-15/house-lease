    ...
    <footer className="bg-black text-white pt-12 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-24">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-blue-400 transition-colors">Listings</a></li>
          ...
          <div>
            ...
            <ul className="text-gray-300 space-y-2">
              <li><a href="mailto:support@houseleaseai.com" className="hover:text-blue-400">Email: support@houseleaseai.com</a></li>
              <li><a href="tel:+15551234567" className="hover:text-blue-400">Phone: +1 (555) 123-4567</a></li>
              <li>Address: Portland, Maryland</li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} HouseLease AI. All rights reserved.</p>
